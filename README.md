...
This library bundles an assortment of functionality such as additional data structures,
Game Database, Persistence, ECS Stats, MVVM, Page Flows, Pooling, Pub/Sub, Vaults,
additional functionality powered by source generators, and so on.
...
2. Select `Add package from git URL...` and paste below URL:
    ```
    https://github.com/laicasaane/EncosyTower.git?path=/Packages/com.laicasaane.encosy-tower#0.1.6-preview.10
    ```
...
```sh
openupm add com.laicasaane.encosy-tower
```
-->
